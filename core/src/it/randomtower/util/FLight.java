...
public class FLight {
	...
	public final static int LightType_Up = 0, LightType_Right = 1, LightType_Down = 2, LightType_Left = 3,
			LightType_SphereTense = 4, LightType_Sphere = 5, LightType_FLARE = 6,
	...
	public final static void addLight(int ax, int ay, float myDist, int myType, int myR, int myG, int myB, int myA) {
		int i = 0;
		// FakeLight
		while (i < myLights.length && myLights[i].isActive())
			i++;
